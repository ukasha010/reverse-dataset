...
{
  tabDisplay<int>(100,1);
  tabDisplay<char_const*>("Hello",2);
  tabDisplay<int>(0x21,4);
  return 0;
}
...
/* void tabDisplay<int>(int, int) */

void tabDisplay<int>(int param_1,int param_2)

{
  ...
  this = (basic_ostream<char,std::char_traits<char>> *)
         std::basic_ostream<char,std::char_traits<char>>::operator<<
                   ((basic_ostream<char,std::char_traits<char>> *)std::cout,param_1);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
...
/* void tabDisplay<char const*>(char const*, int) */

void tabDisplay<char_const*>(char *param_1,int param_2)

{
  ...
  this = std::operator<<((basic_ostream *)std::cout,param_1);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)this,
