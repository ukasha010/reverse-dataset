...
{
  (*(code *)PTR___cxa_begin_catch_00103f58)();
  return;
}
...
{
  (*(code *)PTR___cxa_allocate_exception_00103f60)();
  return;
}
...
{
  (*(code *)PTR___cxa_atexit_00103f70)();
  return;
}
...

{
  ...
  pcVar1 = (char *)(*(code *)PTR_strcpy_00103f78)();
  return pcVar1;
}
...
{
  (*(code *)PTR___cxa_get_exception_ptr_00103f98)();
  return;
}
...

{
  ...
  basic_ostream<char,std::char_traits<char>> *this_01;
  long in_FS_OFFSET;
  int local_7c [23];
  long local_20;
  
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
                    /* try { // try from 00101319 to 001013b0 has its CatchHandler @ 001013ce */
  std::operator<<((basic_ostream *)std::cout,"Enter a positive number : ");
  std::basic_istream<char,std::char_traits<char>>::operator>>
            ((basic_istream<char,std::char_traits<char>> *)std::cin,local_7c);
  if (local_7c[0] < 0) {
    this = (MyException *)__cxa_allocate_exception(0x54);
    MyException::MyException(this,"Not positive",local_7c[0]);
                    /* WARNING: Subroutine does not return */
    __cxa_throw(this,&MyException::typeinfo,0);
  }
  this_00 = std::operator<<((basic_ostream *)std::cout,"Positive number : ");
  this_01 = (basic_ostream<char,std::char_traits<char>> *)
            std::basic_ostream<char,std::char_traits<char>>::operator<<
                      ((basic_ostream<char,std::char_traits<char>> *)this_00,local_7c[0]);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (this_01,(_func_basic_ostream_ptr_basic_ostream_ptr *)
...
/* MyException::MyException(char*, int) */

void __thiscall MyException::MyException(MyException *this,char *param_1,int param_2)
