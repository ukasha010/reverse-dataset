...
{
  (*(code *)PTR___cxa_rethrow_00103fa0)();
  return;
}
...

{
  ...
  *ppcVar1 = "hello";
                    ...
                    /* try { // try from 0010129c to 001012a0 has its CatchHandler @ 001012a1 */
...
{
                    /* try { // try from 0010133b to 0010133f has its CatchHandler @ 0010134a */
  myfunc();
  return 0;
}
