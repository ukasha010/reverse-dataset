...

{
  ...
  for (local_14 = 1; local_14 <= local_1c * local_20; local_14 = local_14 + 1) {
    if ((local_20 % local_14 == 0) && (local_1c % local_14 == 0)) {
      local_18 = local_14;
    }
  }
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"Greatest Common Divisor of ");
  pbVar1 = (basic_ostream *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar1,local_20);
  pbVar1 = std::operator<<(pbVar1," and ");
  pbVar1 = (basic_ostream *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar1,local_1c);
  pbVar1 = std::operator<<(pbVar1," is : ");
