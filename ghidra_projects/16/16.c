...

{
  ...
  iVar1 = (*(code *)PTR_tolower_00103fb8)();
  return iVar1;
}
...

{
  ...
  std::operator<<((basic_ostream *)std::cout,"Enter a uppercase character : ");
  std::operator>>((basic_istream *)std::cin,&local_21);
  pbVar2 = std::operator<<((basic_ostream *)std::cout,local_21);
  pbVar2 = std::operator<<(pbVar2," converted to lowercase --> ");
  pbVar2 = std::operator<<(pbVar2,local_21 + ' ');
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)pbVar2,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar2 = std::operator<<((basic_ostream *)std::cout,local_21);
  pbVar2 = std::operator<<(pbVar2," converted to lowercase (using tolower() function) --> ");
  iVar1 = tolower((int)local_21);
