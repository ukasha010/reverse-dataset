...

{
  ...
  for (local_40._0_4_ = 0; (int)local_40 < 10; local_40._0_4_ = (int)local_40 + 1) {
                    /* try { // try from 00101308 to 001015ae has its CatchHandler @ 001015d3 */
  ...
  while( true ) {
    ...
    cVar2 = std::operator!=((_List_iterator *)&local_48,(_List_iterator *)&local_40);
    if (cVar2 == '\0') break;
  ...
  std::operator<<((basic_ostream *)std::cout,"Modified List : ");
  local_48 = std::__cxx11::list<int,std::allocator<int>>::begin();
  while( true ) {
    std::__cxx11::list<int,std::allocator<int>>::end();
    local_40._0_4_ = extraout_EAX_01;
    local_40._4_4_ = extraout_var_01;
    cVar2 = std::operator!=((_List_iterator *)&local_48,(_List_iterator *)&local_40);
    if (cVar2 == '\0') break;
    piVar3 = (int *)std::_List_iterator<int>::operator*((_List_iterator<int> *)&local_48);
    pbVar4 = (basic_ostream *)
  ...
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)std::cout,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00104fd0);
  std::__cxx11::list<int,std::allocator<int>>::pop_back();
  std::__cxx11::list<int,std::allocator<int>>::pop_front();
  std::operator<<((basic_ostream *)std::cout,"Modified List : ");
  local_48 = std::__cxx11::list<int,std::allocator<int>>::begin();
  while( true ) {
    std::__cxx11::list<int,std::allocator<int>>::end();
    local_40._0_4_ = extraout_EAX_02;
    local_40._4_4_ = extraout_var_02;
    cVar2 = std::operator!=((_List_iterator *)&local_48,(_List_iterator *)&local_40);
    if (cVar2 == '\0') break;
    piVar3 = (int *)std::_List_iterator<int>::operator*((_List_iterator<int> *)&local_48);
    pbVar4 = (basic_ostream *)
...
void std::__cxx11::list<int,std::allocator<int>>::pop_back(void)

{
  list<int,std::allocator<int>> *in_RDI;
  long in_FS_OFFSET;
  undefined8 local_18;
  long local_10;
  
  local_10 = *(long *)(in_FS_OFFSET + 0x28);
  _List_iterator<int>::_List_iterator
            ((_List_iterator<int> *)&local_18,*(_List_node_base **)(in_RDI + 8));
  _M_erase(in_RDI,local_18);
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
void std::__cxx11::list<int,std::allocator<int>>::pop_front(void)
...
void __thiscall
std::__cxx11::list<int,std::allocator<int>>::_M_erase
          (list<int,std::allocator<int>> *this,_List_node *param_2)

{
  int *piVar1;
  allocator *paVar2;
  
  _List_base<int,std::allocator<int>>::_M_dec_size((_List_base<int,std::allocator<int>> *)this,1);
  std::__detail::_List_node_base::_M_unhook();
  piVar1 = (int *)_List_node<int>::_M_valptr();
  paVar2 = (allocator *)_List_base<int,std::allocator<int>>::_M_get_Node_allocator();
  allocator_traits<std::allocator<std::_List_node<int>>>::destroy<int>(paVar2,piVar1);
  _List_base<int,std::allocator<int>>::_M_put_node
            ((_List_base<int,std::allocator<int>> *)this,param_2);
  return;
}
