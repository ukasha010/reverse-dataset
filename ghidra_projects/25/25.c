...

{
  ...
  local_98 = 0x726f6d65646c6f56;
  local_90 = 0x656d616e20732774;
  local_88 = 0x6d6f542073617720;
  local_80 = 0x656c6464695220;
  for (local_bc = 0; *(char *)((long)&local_98 + (long)local_bc) != '\0'; local_bc = local_bc + 1) {
    local_78[local_bc] = *(char *)((long)&local_98 + (long)local_bc);
  }
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"str 1 : ");
  pbVar1 = std::operator<<(pbVar1,(char *)&local_98);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)pbVar1,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"After copying contents of str1 to str2 : ");
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)pbVar1,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"Str 2 : ");
  pbVar1 = std::operator<<(pbVar1,local_78);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)pbVar1,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00103fd0);
  local_b8 = 0x6874206f6c6c6548;
  local_b0 = 0x21657265;
  local_ac = 0;
  pbVar1 = (basic_ostream *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)std::cout,
                      (_func_basic_ostream_ptr_basic_ostream_ptr *)
                      PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar1 = std::operator<<(pbVar1,"With strcpy() func ");
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)pbVar1,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"str3 : ");
  pbVar1 = std::operator<<(pbVar1,(char *)&local_b8);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)pbVar1,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00103fd0);
