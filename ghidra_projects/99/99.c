...
{
  (*(code *)PTR__basic_ifstream_00103f60)();
  return;
}
...

{
  ...
  bVar1 = (bool)(*(code *)PTR_operator_cast_to_bool_00103f98)();
  return bVar1;
}
...
void std::basic_istream<char,std::char_traits<char>>::get(char *param_1)

{
  (*(code *)PTR_get_00103fa8)();
  return;
}
...

{
  ...
  long in_FS_OFFSET;
  char local_249;
  basic_ifstream<char,std::char_traits<char>> local_248 [256];
  basic_ios<char,std::char_traits<char>> abStack_148 [296];
  long local_20;
  
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  std::basic_ifstream<char,std::char_traits<char>>::basic_ifstream((char *)local_248,0x102004);
                    /* try { // try from 00101336 to 001013e7 has its CatchHandler @ 0010140f */
  cVar1 = std::basic_ios<char,std::char_traits<char>>::operator!(abStack_148);
  if (cVar1 == '\0') {
    std::basic_istream<char,std::char_traits<char>>::seekg((long)local_248,0);
    while( true ) {
      plVar3 = (long *)std::basic_istream<char,std::char_traits<char>>::get((char *)local_248);
      bVar2 = std::basic_ios::operator_cast_to_bool
                        ((basic_ios *)((long)plVar3 + *(long *)(*plVar3 + -0x18)));
      if (!bVar2) break;
      std::operator<<((basic_ostream *)std::cout,local_249);
    }
    std::basic_ifstream<char,std::char_traits<char>>::close();
    uVar4 = 0;
  }
  else {
    this = std::operator<<((basic_ostream *)std::cout,"Cannot open file!!");
    std::basic_ostream<char,std::char_traits<char>>::operator<<
              ((basic_ostream<char,std::char_traits<char>> *)this,
  ...
  std::basic_ifstream<char,std::char_traits<char>>::~basic_ifstream(local_248);
