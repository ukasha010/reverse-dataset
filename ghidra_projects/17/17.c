...

{
  ...
  pbVar1 = (basic_istream *)(*(code *)PTR_operator>>_00103fb0)();
  return pbVar1;
}
...

{
  ...
  iVar1 = (*(code *)PTR_toupper_00103fc0)();
  return iVar1;
}
...

{
  ...
  std::operator<<((basic_ostream *)std::cout,"Enter a lowercase character : ");
  std::operator>>((basic_istream *)std::cin,&local_21);
  pbVar2 = std::operator<<((basic_ostream *)std::cout,local_21);
  pbVar2 = std::operator<<(pbVar2," converting to uppercase --> ");
  pbVar2 = std::operator<<(pbVar2,local_21 + -0x20);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)pbVar2,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar2 = std::operator<<((basic_ostream *)std::cout,local_21);
  pbVar2 = std::operator<<(pbVar2,"  converting to uppercase (using toupper() function --> ");
  iVar1 = toupper((int)local_21);
  pbVar2 = std::operator<<(pbVar2,(char)iVar1);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)pbVar2,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00103fd0);
