...

{
  ...
  dVar2 = DAT_00102018;
  dVar1 = DAT_00102010;
  print<int,int>(5,0x14);
  print<double,double>(dVar1,dVar2);
  print<char,char>('c','d');
  return 0;
}
...
void print<int,int>(int param_1,int param_2)
...
void print<double,double>(double param_1,double param_2)
...
void print<char,char>(char param_1,char param_2)

{
  basic_ostream *pbVar1;
  
  pbVar1 = std::operator<<((basic_ostream *)std::cout,param_1);
  pbVar1 = std::operator<<(pbVar1,", ");
