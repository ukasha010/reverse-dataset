...

{
  ...
  pbVar2 = std::operator<<((basic_ostream *)std::cout,"Size of a : ");
  pbVar3 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar2,4);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar3,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar2 = std::operator<<((basic_ostream *)std::cout,"Size of b[] : ");
  pbVar3 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar2,5);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar3,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
