...
{
  (*(code *)PTR___cxa_begin_catch_00103f68)();
  return;
}
...
{
  (*(code *)PTR___cxa_allocate_exception_00103f70)();
  return;
}
...
/* WARNING: Removing unreachable block (ram,0x00101376) */
/* WARNING: Removing unreachable block (ram,0x00101381) */
/* divide(double, double) */

void divide(double param_1,double param_2)

{
  basic_ostream *this;
  basic_ostream<char,std::char_traits<char>> *this_00;
  
  this = std::operator<<((basic_ostream *)std::cout,"Result : ");
  this_00 = (basic_ostream<char,std::char_traits<char>> *)
            std::basic_ostream<char,std::char_traits<char>>::operator<<
                      ((basic_ostream<char,std::char_traits<char>> *)this,param_1 / param_2);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
