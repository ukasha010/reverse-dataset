...

{
  ...
  int *piVar1;
                    ...
                    /* try { // try from 0010128d to 001012e3 has its CatchHandler @ 001012e4 */
  this = std::operator<<((basic_ostream *)std::cout,"Inside myfunc : ");
...
{
                    /* try { // try from 00101375 to 0010138d has its CatchHandler @ 00101395 */
  myFunc(0x4c);
  myFunc(0x22);
  myFunc(0x17);
  return 0;
