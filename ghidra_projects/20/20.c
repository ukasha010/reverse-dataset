...

{
  ...
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"Input 10 elements : ");
  std::basic_ostream<char,std::char_traits<char>>::operator<<
  ...
  for (local_54 = 0; local_54 < 10; local_54 = local_54 + 1) {
    pbVar1 = std::operator<<((basic_ostream *)std::cout,"Enter element ");
    pbVar1 = (basic_ostream *)
             std::basic_ostream<char,std::char_traits<char>>::operator<<
                       ((basic_ostream<char,std::char_traits<char>> *)pbVar1,local_54 + 1);
    std::operator<<(pbVar1," : ");
    std::basic_istream<char,std::char_traits<char>>::operator>>
              ((basic_istream<char,std::char_traits<char>> *)std::cin,local_48 + local_54);
  }
  local_50 = -10000000;
  for (local_4c = 0; local_4c < 10; local_4c = local_4c + 1) {
    if (local_50 < local_48[local_4c]) {
      local_50 = local_48[local_4c];
    }
  }
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"Largest element in the array : ");
  pbVar2 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar1,local_50);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar2,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"Using library function : ");
  piVar3 = std::max<int>(local_48,(int *)local_20);
  pbVar2 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar1,*piVar3);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar2,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
