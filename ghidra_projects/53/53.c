...

{
  ...
  std::allocator<int>::allocator();
                    /* try { // try from 0010136c to 00101370 has its CatchHandler @ 001015c4 */
  std::vector<int,std::allocator<int>>::vector((initializer_list)local_68,(allocator *)&local_48);
  std::allocator<int>::~allocator((allocator<int> *)&local_70);
  local_88 = std::vector<int,std::allocator<int>>::begin();
                    /* try { // try from 001013a1 to 0010159f has its CatchHandler @ 001015e2 */
  std::operator<<((basic_ostream *)std::cout,"Vector v : ");
  while( true ) {
    local_70 = std::vector<int,std::allocator<int>>::end();
    bVar2 = __gnu_cxx::operator!=((__normal_iterator *)&local_88,(__normal_iterator *)&local_70);
    if (!bVar2) break;
  ...
  uVar6 = __gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>::operator-
                    ((__normal_iterator<int*,std::vector<int,std::allocator<int>>> *)&local_80,1);
  uVar7 = std::vector<int,std::allocator<int>>::begin();
  local_78 = std::
             adjacent_find<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>
                       (uVar7,uVar6);
  piVar8 = (int *)__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>::operator*
  ...
  if (iVar1 == *piVar8) {
    pbVar3 = std::operator<<((basic_ostream *)std::cout,
                             "Vector does not contain any similar elements!");
    std::basic_ostream<char,std::char_traits<char>>::operator<<
    ...
    std::operator<<((basic_ostream *)std::cout,"Yes adjacent element found\n");
    local_78 = std::vector<int,std::allocator<int>>::begin();
    uVar6 = __gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>::operator+
                      ((__normal_iterator<int*,std::vector<int,std::allocator<int>>> *)&local_78,3);
    uVar7 = std::vector<int,std::allocator<int>>::begin();
    local_70 = std::
               adjacent_find<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>
                         (uVar7,uVar6);
...

{
  ...
  piVar3 = (int *)initializer_list<int>::begin();
                    /* try { // try from 0010176d to 00101771 has its CatchHandler @ 00101774 */
...
/* __gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >
   std::adjacent_find<__gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >
   >(__gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >,
   __gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >) */

void std::adjacent_find<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>>
               (undefined8 param_1,undefined8 param_2)

{
  __gnu_cxx::__ops::__iter_equal_to_iter();
  __adjacent_find<__gnu_cxx::__normal_iterator<int*,std::vector<int,std::allocator<int>>>,__gnu_cxx::__ops::_Iter_equal_to_iter>
            (param_1,param_2);
  return;
}
...

{
  ...
  if (!bVar1) {
    ...
    do {
      ...
      uVar4 = local_28;
      if (!bVar1) break;
      cVar2 = __gnu_cxx::__ops::_Iter_equal_to_iter::operator()(&local_29,local_20,local_18);
      uVar4 = local_20;
    } while (cVar2 == '\0');
  }
  if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
...
__gnu_cxx::__ops::_Iter_equal_to_iter::operator()
          (_Iter_equal_to_iter *this,undefined8 param_2,undefined8 param_3)
