...
std::basic_ostream<char,std::char_traits<char>>::operator<<
          (basic_ostream<char,std::char_traits<char>> *this,short param_1)
...
int addVal(int param_1,int param_2)

{
  basic_ostream *this;
  
  this = std::operator<<((basic_ostream *)std::cout,"\nInside addVal int specialization");
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)this,
...

{
  ...
  dVar1 = DAT_00102090;
  dVar6 = DAT_00102088;
  pbVar4 = std::operator<<((basic_ostream *)std::cout,"Adding the integers : ");
  iVar3 = addVal(500,0x398);
  pbVar5 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar4,iVar3);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar5,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar4 = std::operator<<((basic_ostream *)std::cout,"Adding the double : ");
  dVar6 = addVal<double>(dVar6,dVar1);
  pbVar5 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar4,dVar6);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar5,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar4 = std::operator<<((basic_ostream *)std::cout,"Adding the short : ");
  sVar2 = addVal<short>(2,4);
  pbVar5 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar4,sVar2);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar5,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
  return 0;
...
void _GLOBAL__sub_I_addVal(void)
...
/* double addVal<double>(double, double) */

double addVal<double>(double param_1,double param_2)

{
  basic_ostream *this;
  
  this = std::operator<<((basic_ostream *)std::cout,"\nInside template addVal");
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)this,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00103fd0);
...
/* short addVal<short>(short, short) */

short addVal<short>(short param_1,short param_2)
