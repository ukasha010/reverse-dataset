...

{
  ...
  dVar1 = (double)(*(code *)PTR_modf_00103fb8)();
  return dVar1;
}
...

{
  ...
  this = std::operator<<((basic_ostream *)std::cout,"Value of i : ");
...

{
  ...
  local_18 = modf(param_1,&local_20);
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"Fractional part : ");
  ...
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar2,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"Integer part : ");
  pbVar2 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
