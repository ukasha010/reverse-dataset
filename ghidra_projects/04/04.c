...
std::basic_ostream<char,std::char_traits<char>>::operator<<
          (basic_ostream<char,std::char_traits<char>> *this,longlong param_1)
...

{
  ...
  std::operator<<((basic_ostream *)std::cout,"Enter a number n : ");
  std::basic_istream<char,std::char_traits<char>>::operator>>
            ((basic_istream<char,std::char_traits<char>> *)std::cin,&local_1c);
  local_18 = Fact(local_1c);
  this = std::operator<<((basic_ostream *)std::cout,"Factorial of the given number is : ");
  this_00 = (basic_ostream<char,std::char_traits<char>> *)
            std::basic_ostream<char,std::char_traits<char>>::operator<<
                      ((basic_ostream<char,std::char_traits<char>> *)this,local_18);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
