...

{
  ...
  std::operator<<((basic_ostream *)std::cout,"Enter a character : ");
  std::operator>>((basic_istream *)std::cin,&local_11);
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"ASCII of ");
  pbVar1 = std::operator<<(pbVar1,local_11);
  pbVar1 = std::operator<<(pbVar1," is ");
  this = (basic_ostream<char,std::char_traits<char>> *)
         std::basic_ostream<char,std::char_traits<char>>::operator<<
                   ((basic_ostream<char,std::char_traits<char>> *)pbVar1,(int)local_11);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
