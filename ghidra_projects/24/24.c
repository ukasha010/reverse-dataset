...

{
  ...
  local_2c = 4;
  local_28 = 5;
  this = std::operator<<((basic_ostream *)std::cout,"Average of the array : ");
  iVar1 = std::accumulate<int*,int>(&local_38,&local_24,0);
  this_00 = (basic_ostream<char,std::char_traits<char>> *)
            std::basic_ostream<char,std::char_traits<char>>::operator<<
                      ((basic_ostream<char,std::char_traits<char>> *)this,iVar1 / 5);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* int std::accumulate<int*, int>(int*, int*, int) */

int std::accumulate<int*,int>(int *param_1,int *param_2,int param_3)
