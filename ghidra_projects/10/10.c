...
undefined4 DecToBin(int param_1)

{
  ...
  for (local_1c = param_1; 0 < local_1c; local_1c = local_1c / 2) {
    local_c = local_c + local_1c % 2;
    if (1 < local_1c) {
      local_c = local_c * 10;
    }
  }
  uVar1 = Reverse(local_c);
  return uVar1;
}
...

{
  ...
  std::basic_istream<char,std::char_traits<char>>::operator>>
            ((basic_istream<char,std::char_traits<char>> *)std::cin,&local_24);
  this = std::operator<<((basic_ostream *)std::cout,"Binary form : ");
  iVar1 = DecToBin(local_24);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)this,iVar1);
...
void _GLOBAL__sub_I_Reverse(void)
