...

{
  ...
  local_28 = 5;
  local_24 = 0x14;
  local_20 = DAT_00102050;
  local_18 = DAT_00102058;
  local_2a = 'c';
  local_29 = 'd';
  std::operator<<((basic_ostream *)std::cout,"Original : ");
  ...
  pbVar2 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar1,local_24);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
  ...
  pbVar1 = (basic_ostream *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar1,local_20);
  pbVar1 = std::operator<<(pbVar1,"\ny : ");
  pbVar2 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)pbVar1,local_18);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar2,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
  pbVar1 = std::operator<<((basic_ostream *)std::cout,"\nm : ");
  pbVar1 = std::operator<<(pbVar1,local_2a);
  pbVar1 = std::operator<<(pbVar1,"\nn : ");
  pbVar1 = std::operator<<(pbVar1,local_29);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            ((basic_ostream<char,std::char_traits<char>> *)pbVar1,
             (_func_basic_ostream_ptr_basic_ostream_ptr *)
             PTR_endl<char,std_char_traits<char>>_00103fd0);
  swapArgs<int>(&local_28,&local_24);
  swapArgs<double>(&local_20,&local_18);
  swapArgs<char>(&local_2a,&local_29);
...
/* void swapArgs<int>(int&, int&) */

void swapArgs<int>(int *param_1,int *param_2)
...
/* void swapArgs<double>(double&, double&) */

void swapArgs<double>(double *param_1,double *param_2)
...
/* void swapArgs<char>(char&, char&) */

void swapArgs<char>(char *param_1,char *param_2)
