...

{
  ...
  dVar1 = (double)(*(code *)PTR_pow_00103fb8)();
  return dVar1;
}
...

{
  ...
  std::operator<<((basic_ostream *)std::cout,"Enter a number : ");
  std::basic_istream<char,std::char_traits<char>>::operator>>
            ((basic_istream<char,std::char_traits<char>> *)std::cin,&local_14);
  pbVar1 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)std::cout,
                      local_14 * local_14 * local_14);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar1,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
  std::pow<int,int>(local_14,3);
  pbVar1 = (basic_ostream<char,std::char_traits<char>> *)
           std::basic_ostream<char,std::char_traits<char>>::operator<<
                     ((basic_ostream<char,std::char_traits<char>> *)std::cout,extraout_XMM0_Qa);
  std::basic_ostream<char,std::char_traits<char>>::operator<<
            (pbVar1,(_func_basic_ostream_ptr_basic_ostream_ptr *)
                    PTR_endl<char,std_char_traits<char>>_00103fd0);
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* __gnu_cxx::__promote_2<int, int, __gnu_cxx::__promote<int,
   std::__is_integer<int>::__value>::__type, __gnu_cxx::__promote<int,
   std::__is_integer<int>::__value>::__type>::__type std::pow<int, int>(int, int) */
